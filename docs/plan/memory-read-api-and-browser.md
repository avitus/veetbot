...
(memory-formation-and-consolidation.md:497-507). That surface is right for an
...
different surface* (memory-retrieval-and-ranking.md:710-711), and that surface
...
2. **Recall-trace viewing.** There is a precondition and it is a defect:
   ...
   rule (memory-retrieval-and-ranking.md:715-721), which is a second ceiling
