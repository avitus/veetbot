...
The 26 subject specifications declare 398 gates, the engineering plan
declares 2 more, and this document declares 7 over the corpus: 407
declarations, 404 registry entries once the 3 aliases are subtracted.
...
2.  **Forty-one of four hundred and four gates are green before
...
The cumulative column reaches four hundred and four, which is every registry
entry, at Milestone 23. Six of Milestone 10's gates are
...
`gate.schedule.*`. Every authorized milestone now has a specification
