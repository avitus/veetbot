...
executable vocabulary twenty-five strings. Milestone 17, authorized as a
parallel workstream rather than the next number in sequence
([ADR-0070](../adr/0070-milestone-17-memory-read-api-and-browser.md)), adds
one more:
...
contributor the list cannot enumerate. `tool-system.md:1230` takes an MCP
