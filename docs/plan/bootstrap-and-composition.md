...
`MAX_COMPACTIONS_PER_STEP = 2`, the RRF constant `k = 60`, the 13,500-token
...
src/agent_core/
  ...
  context/plan.yaml        region caps, reserves, the 13,500 ceiling
...
classes sum to at most 13,500 tokens. Nothing has been constructed yet, so
...
| Prefix classes fit the 13,500 ceiling | context spec | 1 and per session |
