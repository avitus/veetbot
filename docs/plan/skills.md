...
Section 30.2 at `engineering-plan.md:4749` calls it *"a skill_manage
...
sentence was wrong, and `tool-system.md:1463` carries the corrected
sentence now.
...
`tool-system.md:1467` requires `skill.write`. The earlier string was wrong in
two ways against
...
4  "skills have no design at all"     tool-system.md:1421-1468
...
second half is true. The first is not: `tool-system.md:1421-1468` is
