...
could already exist at `engineering-plan.md:582` with no design behind
...
Section 30.2 at `engineering-plan.md:4586` calls it *"a skill_manage
...
`tool-system.md:244` requires every control tool to be `READ_ONLY` or
...
sentence was wrong, and `tool-system.md:1377` carries the corrected
sentence now.
...
The registry name carries the dot the grammar at `tool-system.md:344`
...
`tool-system.md:1381` requires `skill.write`. The earlier string was wrong in
two ways against
...
4  "skills have no design at all"     tool-system.md:1335-1382
...
second half is true. The first is not: `tool-system.md:1335-1382` is
...
`readiness.md:741-743` cites `engineering-plan.md:2888`, the
