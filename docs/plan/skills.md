...
Section 30.2 at `engineering-plan.md:4323` calls it *"a skill_manage
...
4  "skills have no design at all"     tool-system.md:1310-1357
...
second half is true. The first is not: `tool-system.md:1310-1357` is
