...
could already exist at `engineering-plan.md:523` with no design behind
...
Section 30.2 at `engineering-plan.md:4122` calls it *"a skill_manage
...
`readiness.md:739-744` cites `engineering-plan.md:2818`, the
