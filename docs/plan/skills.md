...
could already exist at `engineering-plan.md:465` with no design behind
...
Section 30.2 at `engineering-plan.md:3754` calls it *"a skill_manage
...
`readiness.md:734` cited `engineering-plan.md:2760` for the
version-pinning acceptance criterion, which is at
`engineering-plan.md:2760`; the line it named is an MCP
