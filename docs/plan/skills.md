...
could already exist at `engineering-plan.md:458` with no design behind
...
Section 30.2 at `engineering-plan.md:3516` calls it *"a skill_manage
...
`readiness.md:729` cited `engineering-plan.md:2753` for the
version-pinning acceptance criterion, which is at
`engineering-plan.md:2753`; the line it named is an MCP
