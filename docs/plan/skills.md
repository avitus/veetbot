...
sentence was wrong, and `tool-system.md:1413` carries the corrected
sentence now.
...
`tool-system.md:1417` requires `skill.write`. The earlier string was wrong in
two ways against
...
4  "skills have no design at all"     tool-system.md:1371-1418
...
second half is true. The first is not: `tool-system.md:1371-1418` is
