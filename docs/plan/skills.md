...
Section 30.2 at `engineering-plan.md:4602` calls it *"a skill_manage
...
sentence was wrong, and `tool-system.md:1400` carries the corrected
sentence now.
...
`tool-system.md:1404` requires `skill.write`. The earlier string was wrong in
two ways against
...
4  "skills have no design at all"     tool-system.md:1358-1405
...
second half is true. The first is not: `tool-system.md:1358-1405` is
