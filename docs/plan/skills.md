...
Section 30.2 at `engineering-plan.md:4434` calls it *"a skill_manage
...
sentence was wrong, and `tool-system.md:1359` carries the corrected
sentence now.
...
`tool-system.md:1363` requires `skill.write`. The earlier string was wrong in
two ways against
...
4  "skills have no design at all"     tool-system.md:1317-1364
...
second half is true. The first is not: `tool-system.md:1317-1364` is
...
`readiness.md:741-743` cites `engineering-plan.md:2850`, the
