...
could already exist at `engineering-plan.md:479` with no design behind
...
Section 30.2 at `engineering-plan.md:3893` calls it *"a skill_manage
...
`readiness.md:736-737` cited `engineering-plan.md:2778` for the
version-pinning acceptance criterion, which is at
`engineering-plan.md:2778`; the line it named is an MCP
