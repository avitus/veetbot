...
sentence was wrong, and `tool-system.md:1374` carries the corrected
sentence now.
...
`tool-system.md:1378` requires `skill.write`. The earlier string was wrong in
two ways against
...
4  "skills have no design at all"     tool-system.md:1332-1379
...
second half is true. The first is not: `tool-system.md:1332-1379` is
