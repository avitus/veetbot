...
Section 30.2 at `engineering-plan.md:4573` calls it *"a skill_manage
...
sentence was wrong, and `tool-system.md:1366` carries the corrected
sentence now.
...
`tool-system.md:1370` requires `skill.write`. The earlier string was wrong in
two ways against
...
4  "skills have no design at all"     tool-system.md:1324-1371
...
second half is true. The first is not: `tool-system.md:1324-1371` is
