...
could already exist at `engineering-plan.md:469` with no design behind
...
Section 30.2 at `engineering-plan.md:3771` calls it *"a skill_manage
...
`readiness.md:733` cited `engineering-plan.md:2764` for the
version-pinning acceptance criterion, which is at
`engineering-plan.md:2764`; the line it named is an MCP
