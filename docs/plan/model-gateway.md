...
profile. `bootstrap-and-composition.md:395-396` places `models/policies.yaml`
...
the four things `bootstrap-and-composition.md:396` names it for and becomes
...
family of the secret scanner at `bootstrap-and-composition.md:1181-1222` is
...
7. Is one file per provider profile right, given that
   `bootstrap-and-composition.md:395` describes a single `models/policies.yaml`
