...
profile. `bootstrap-and-composition.md:398-399` places `models/policies.yaml`
...
the four things `bootstrap-and-composition.md:399` names it for and becomes
...
family of the secret scanner at `bootstrap-and-composition.md:1185-1226` is
...
`policy_version` at `policy-and-approvals.md:815` because it answers the
...
`policy-and-approvals.md:1016-1045` maps trust tiers to policy restrictiveness,
...
7. Is one file per provider profile right, given that
   `bootstrap-and-composition.md:398` describes a single `models/policies.yaml`
