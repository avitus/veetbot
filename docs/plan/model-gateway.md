...
profile. `bootstrap-and-composition.md:377-378` places `models/policies.yaml`
...
the four things `bootstrap-and-composition.md:378` names it for and becomes
...
family of the secret scanner at `bootstrap-and-composition.md:1142-1183` is
...
`policy_version` at `policy-and-approvals.md:678` because it answers the
...
`policy-and-approvals.md:873-902` maps trust tiers to policy restrictiveness,
...
7. Is one file per provider profile right, given that
   `bootstrap-and-composition.md:377` describes a single `models/policies.yaml`
