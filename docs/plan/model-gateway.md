...
profile. `bootstrap-and-composition.md:376-377` places `models/policies.yaml`
...
the four things `bootstrap-and-composition.md:377` names it for and becomes
...
family of the secret scanner at `bootstrap-and-composition.md:1140-1181` is
...
7. Is one file per provider profile right, given that
   `bootstrap-and-composition.md:376` describes a single `models/policies.yaml`
