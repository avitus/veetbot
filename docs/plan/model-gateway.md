...
profile. `bootstrap-and-composition.md:382-383` places `models/policies.yaml`
...
the four things `bootstrap-and-composition.md:383` names it for and becomes
...
family of the secret scanner at `bootstrap-and-composition.md:1161-1202` is
...
`policy_version` at `policy-and-approvals.md:684` because it answers the
...
`policy-and-approvals.md:879-908` maps trust tiers to policy restrictiveness,
...
7. Is one file per provider profile right, given that
   `bootstrap-and-composition.md:382` describes a single `models/policies.yaml`
