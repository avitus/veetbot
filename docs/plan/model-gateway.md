...
(`context-engine.md:904-906`). The gateway translates those hints into
...
The cached-prefix ratio is defined in `context-engine.md:882-884` and the
...
be answerable by a tool result; `context-engine.md:453-457` requires that a
