...
profile. `bootstrap-and-composition.md:370-371` places `models/policies.yaml`
...
the four things `bootstrap-and-composition.md:371` names it for and becomes
...
family of the secret scanner at `bootstrap-and-composition.md:1134-1175` is
...
7. Is one file per provider profile right, given that
   `bootstrap-and-composition.md:370` describes a single `models/policies.yaml`
