...
Section 28 of the plan is not empty — `engineering-plan.md:3224-3301`
...
1.  **The plan demands a red-team test with no case behind it.**
    `engineering-plan.md:3299` requires a container-escape attempt as
...
`engineering-plan.md:3208` and `engineering-plan.md:2902` and picked
...
`engineering-plan.md:3303-3456` for links to other documents returned
...
4.  **The container-escape test and the case table.**
    `engineering-plan.md:3299` requires a test the harness's case set
