...
Section 28 of the plan is not empty — `engineering-plan.md:4402-4479`
...
1.  **The plan demands a red-team test with no case behind it.**
    `engineering-plan.md:4477` requires a container-escape attempt as
...
`engineering-plan.md:4481-4638` for links to other documents returned
...
4.  **The container-escape test and the case table.**
    `engineering-plan.md:4477` requires a test the harness's case set
