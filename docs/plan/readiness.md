...
(Section 6.5)"* in Milestone 2 at `engineering-plan.md:2603`, while
...
`engineering-plan.md:1896-2103`, designs the API more thoroughly than
...
3.  **`Idempotency-Key` handling is named in two places and specified
    ...
    `engineering-plan.md:1988` and as an implement bullet, and the
...
Section 28 of the plan is not empty — `engineering-plan.md:4253-4330`
...
1.  **The plan demands a red-team test with no case behind it.**
    `engineering-plan.md:4332` requires a container-escape attempt as
...
`engineering-plan.md:2853` had no design behind it — and no document
...
`engineering-plan.md:3238` and `engineering-plan.md:3239` and picked
...
`engineering-plan.md:4332-4490` for links to other documents returned
...
`engineering-plan.md:2853`, and the line this review first named was
...
2.  **Usage token classes and cost-source precedence at Milestone 2 or
    Milestone 3.** `engineering-plan.md:2603` against
...
4.  **The container-escape test and the case table.**
    `engineering-plan.md:4332` requires a test the harness's case set
