...
Section 28 of the plan is not empty — `engineering-plan.md:4303-4380`
...
1.  **The plan demands a red-team test with no case behind it.**
    `engineering-plan.md:4382` requires a container-escape attempt as
...
`engineering-plan.md:3266` and `engineering-plan.md:3267` and picked
...
The readiness verdict is **Authorized**: ADR-0077, thirty-one new
...
`engineering-plan.md:4382-4540` for links to other documents returned
...
2.  **Usage token classes and cost-source precedence at Milestone 2 or
    ...
    `model-gateway.md:1810` and `milestone-map.md:1659`. The map
...
4.  **The container-escape test and the case table.**
    `engineering-plan.md:4382` requires a test the harness's case set
