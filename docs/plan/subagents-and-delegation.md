...
(engineering-plan.md:3087-3095). This document honours that gate as written.
...
interaction and the final response, engineering-plan.md:3085); role-named
agents for planning, writing, or criticism (engineering-plan.md:3097);
