...
principal (tool-system.md:973-979); the child seeds from the parent's concise
...
The readiness review measured what was left (readiness.md:1001-1005 and
...
7. Inserts one `delegations` row carrying every child and marks the parent's
   ...
   tool-system.md:965-968 already declares). Steps 3 through 6 repeat per
...
authorizations (tool-system.md:973-979). A child result that instructs the
