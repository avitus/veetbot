...
recall of consequential facts (memory-formation-and-consolidation.md:685).
...
that is opt-in per principal (memory-formation-and-consolidation.md:712) are
...
(memory-formation-and-consolidation.md:712), so it is a command and it demands
