...
recall of consequential facts (memory-formation-and-consolidation.md:744).
...
that is opt-in per principal (memory-formation-and-consolidation.md:771) are
...
(memory-formation-and-consolidation.md:771), so it is a command and it demands
