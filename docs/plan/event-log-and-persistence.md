...
alongside the run insert (`http-api-and-streaming.md:623`), while a worker may
...
2. **Pattern replacement.** The secret scanner's five rule families
   (`bootstrap-and-composition.md:1089-1094`) run over every message body,
...
(`bootstrap-and-composition.md:1099`).
...
(`bootstrap-and-composition.md:961`), which is cheaper than a thirteenth
