...
2. **Pattern replacement.** The secret scanner's five rule families
   (`bootstrap-and-composition.md:1198-1206`) run over every message body,
...
(`bootstrap-and-composition.md:1211-1213`).
...
(`bootstrap-and-composition.md:1035`), which is cheaper than a thirteenth
