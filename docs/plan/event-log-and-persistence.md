...
2. **Pattern replacement.** The secret scanner's five rule families
   (`bootstrap-and-composition.md:1160-1168`) run over every message body,
...
(`bootstrap-and-composition.md:1173-1175`).
...
(`bootstrap-and-composition.md:997`), which is cheaper than a thirteenth
