...
2. **Pattern replacement.** The secret scanner's five rule families
   (`bootstrap-and-composition.md:1208-1216`) run over every message body,
...
(`bootstrap-and-composition.md:1221-1223`).
...
(`bootstrap-and-composition.md:1045`), which is cheaper than a thirteenth
