...
2. **Pattern replacement.** The secret scanner's five rule families
   (`bootstrap-and-composition.md:1168-1176`) run over every message body,
...
(`bootstrap-and-composition.md:1181-1183`).
...
(`bootstrap-and-composition.md:1005`), which is cheaper than a thirteenth
