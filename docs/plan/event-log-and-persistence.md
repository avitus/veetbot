...
alongside the run insert (`http-api-and-streaming.md:839`), while a worker may
...
2. **Pattern replacement.** The secret scanner's five rule families
   (`bootstrap-and-composition.md:1196-1204`) run over every message body,
...
(`bootstrap-and-composition.md:1209-1211`).
...
(`bootstrap-and-composition.md:1033`), which is cheaper than a thirteenth
