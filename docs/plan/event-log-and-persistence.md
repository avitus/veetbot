...
2. **Pattern replacement.** The secret scanner's five rule families
   (`bootstrap-and-composition.md:1101-1109`) run over every message body,
...
(`bootstrap-and-composition.md:1104`).
...
(`bootstrap-and-composition.md:966`), which is cheaper than a thirteenth
