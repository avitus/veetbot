...
2. **Pattern replacement.** The secret scanner's five rule families
   (`bootstrap-and-composition.md:1211-1219`) run over every message body,
...
(`bootstrap-and-composition.md:1224-1226`).
...
(`bootstrap-and-composition.md:1048`), which is cheaper than a thirteenth
