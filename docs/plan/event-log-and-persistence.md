...
alongside the run insert (`http-api-and-streaming.md:781`), while a worker may
...
2. **Pattern replacement.** The secret scanner's five rule families
   (`bootstrap-and-composition.md:1164-1172`) run over every message body,
...
(`bootstrap-and-composition.md:1177-1179`).
...
(`bootstrap-and-composition.md:1001`), which is cheaper than a thirteenth
