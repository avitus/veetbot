...
2. **Pattern replacement.** The secret scanner's five rule families
   (`bootstrap-and-composition.md:1166-1174`) run over every message body,
...
(`bootstrap-and-composition.md:1179-1181`).
...
(`bootstrap-and-composition.md:1003`), which is cheaper than a thirteenth
