...
2. **Pattern replacement.** The secret scanner's five rule families
   (`bootstrap-and-composition.md:1207-1215`) run over every message body,
...
(`bootstrap-and-composition.md:1220-1222`).
...
(`bootstrap-and-composition.md:1044`), which is cheaper than a thirteenth
