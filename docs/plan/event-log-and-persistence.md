...
alongside the run insert (`http-api-and-streaming.md:842`), while a worker may
...
2. **Pattern replacement.** The secret scanner's five rule families
   (`bootstrap-and-composition.md:1197-1205`) run over every message body,
...
(`bootstrap-and-composition.md:1210-1212`).
...
(`bootstrap-and-composition.md:1034`), which is cheaper than a thirteenth
