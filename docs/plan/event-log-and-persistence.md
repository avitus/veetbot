...
2. **Pattern replacement.** The secret scanner's five rule families
   (`bootstrap-and-composition.md:1209-1217`) run over every message body,
...
(`bootstrap-and-composition.md:1222-1224`).
...
(`bootstrap-and-composition.md:1046`), which is cheaper than a thirteenth
