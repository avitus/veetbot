...
2. **Pattern replacement.** The secret scanner's five rule families
   (`bootstrap-and-composition.md:1234-1242`) run over every message body,
...
(`bootstrap-and-composition.md:1247-1249`).
...
(`bootstrap-and-composition.md:1069`), which is cheaper than a thirteenth
