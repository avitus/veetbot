...
2. **Pattern replacement.** The secret scanner's five rule families
   (`bootstrap-and-composition.md:1087-1092`) run over every message body,
...
(`bootstrap-and-composition.md:1097`).
...
(`bootstrap-and-composition.md:959`), which is cheaper than a thirteenth
