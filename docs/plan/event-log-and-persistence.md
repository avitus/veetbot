...
2. **Pattern replacement.** The secret scanner's five rule families
   (`bootstrap-and-composition.md:1210-1218`) run over every message body,
...
(`bootstrap-and-composition.md:1223-1225`).
...
(`bootstrap-and-composition.md:1047`), which is cheaper than a thirteenth
