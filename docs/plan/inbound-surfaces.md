...
their behalf" (engineering-plan.md:3716-3717). Section 22 repeats the
default-deny as a security-baseline item (engineering-plan.md:3334), ADR-0017
...
- Default-deny and pairing before any run (engineering-plan.md:3334, ADR-0017
