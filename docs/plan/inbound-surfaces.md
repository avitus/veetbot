...
their behalf" (engineering-plan.md:4601-4602). Section 22 repeats the
default-deny as a security-baseline item (engineering-plan.md:4219), ADR-0017
...
- Default-deny and pairing before any run (engineering-plan.md:4219, ADR-0017
