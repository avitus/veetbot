...
their behalf" (engineering-plan.md:4402-4403). Section 22 repeats the
default-deny as a security-baseline item (engineering-plan.md:4025), ADR-0017
...
- Default-deny and pairing before any run (engineering-plan.md:4025, ADR-0017
