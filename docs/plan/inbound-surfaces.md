...
their behalf" (engineering-plan.md:4350-4351). Section 22 repeats the
default-deny as a security-baseline item (engineering-plan.md:3973), ADR-0017
...
- Default-deny and pairing before any run (engineering-plan.md:3973, ADR-0017
