...
their behalf" (engineering-plan.md:4575-4576). Section 22 repeats the
default-deny as a security-baseline item (engineering-plan.md:4193), ADR-0017
...
- Default-deny and pairing before any run (engineering-plan.md:4193, ADR-0017
